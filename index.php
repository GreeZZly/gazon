            ...
            <ul class="bxslider_rev">
                ...
                <li>
                  <div class="rev_item row">
                    ...
                    <div class="col-xs-9">
                      Устанавливала 3 месяца назад в этой фирме гбо на свой субарик . Хотела установить brc, т.к. его везде хвалят, НО!!! Когда приехала в гарант-газ и ребята посеветовали kme (он лучше, круче, вообщем отзывы не хуже brc, и стоит чуть дешевле). Поставили оборудование и …. ВСЁ СУПЕР! Работает без вопросов, вспоминаю о том, что еду на газу только, когда заканчивается газ в баллоне и пищит сигнал, и это радует!
